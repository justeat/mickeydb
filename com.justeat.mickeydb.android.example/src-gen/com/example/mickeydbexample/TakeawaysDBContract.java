...
public class TakeawaysDBContract  {
	...
	private static String initAuthority() {
		String authority = "com.example.mickeydbexample.takeawaysdb";

		try {
    		
    		ClassLoader loader = TakeawaysDBContract.class.getClassLoader();
    		
			Class<?> clz = loader.loadClass("com.example.mickeydbexample.TakeawaysDBContentProviderAuthority");
	...
	public static class Restaurants implements RestaurantsColumns, BaseColumns {
		 ...
		 * eg:- content://com.example.mickeydbexample.takeawaysdb/restaurants/123.</p>
		 */
	...
	public static class AllRestaurants implements AllRestaurantsColumns, BaseColumns {
		 ...
		 * eg:- content://com.example.mickeydbexample.takeawaysdb/all_restaurants/123.</p>
		 */
	    public static Uri buildUriWithId(long id) {
	        return CONTENT_URI.buildUpon().appendPath(String.valueOf(id)).build();
	    }
