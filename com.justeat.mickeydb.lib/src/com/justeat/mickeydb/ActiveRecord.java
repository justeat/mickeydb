...
/**
 * <p>Base for all generated mickey ActiveRecord implementations</p>
 *
 */
public abstract class ActiveRecord {
	...
	protected ActiveRecord(Context context, Uri contentUri) {
		mContext = context;
	...
	public boolean delete(boolean notifyChange){		
		...
		boolean result = mContext.getContentResolver().delete(uri, null, null) > 0;
	...
	public void reload(){
	    ...
	    try {
	        c = mContext.getContentResolver().query(mContentUri.buildUpon()
