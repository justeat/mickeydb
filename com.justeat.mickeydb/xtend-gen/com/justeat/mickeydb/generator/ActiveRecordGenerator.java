...
public class ActiveRecordGenerator {
  public CharSequence generate(final String packageName, final String databaseName, final TableDefinition stmt) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("import com.justeat.mickeydb.util.Closeables;");
    _builder.newLine();
    _builder.append("import com.justeat.mickeydb.ActiveRecord;");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("ContentResolver resolver = Mickey.getContentResolver();");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.newLine();
    _builder.append("\t    ");
