  ...
  public CharSequence generate(final MickeyDatabaseModel model, final ContentUris content) {
      ...
      for(final ContentUriInfo uri_3 : content.uris) {
        {
          ...
          if (_isDirectory) {
            ...
            String _pascalize_4 = Strings.pascalize(_type);
            ...
            String _pascalize_6 = Strings.pascalize(_type_1);
    ...
    _builder.newLine();
    {
      for(final ContentUriInfo uri_4 : content.uris) {
        ...
        String _pascalize_9 = Strings.pascalize(_name_1);
    ...
    _builder.newLine();
    {
      for(final ContentUriInfo uri_5 : content.uris) {
        ...
        String _pascalize_10 = Strings.pascalize(_name_2);
        ...
        String _pascalize_11 = Strings.pascalize(_name_3);
