...
public interface CreateViewStatement extends TableDefinition
{
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getCreateViewStatement_Temporary()
   * @model
   * @generated
   */
  boolean isTemporary();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.CreateViewStatement#isTemporary <em>Temporary</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getCreateViewStatement_SelectStatement()
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.CreateViewStatement#getSelectStatement <em>Select Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
