 ...
 *   <li>{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isOuter <em>Outer</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isInner <em>Inner</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isCross <em>Cross</em>}</li>
...
public interface JoinStatement extends EObject
{
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getJoinStatement_Natural()
   * @model
   * @generated
   */
  boolean isNatural();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isNatural <em>Natural</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setLeft(boolean)
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getJoinStatement_Left()
   * @model
   * @generated
   */
  boolean isLeft();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isLeft <em>Left</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getJoinStatement_Outer()
   * @model
   * @generated
   */
  boolean isOuter();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isOuter <em>Outer</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getJoinStatement_Inner()
   * @model
   * @generated
   */
  boolean isInner();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isInner <em>Inner</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getJoinStatement_Cross()
   * @model
   * @generated
   */
  boolean isCross();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.JoinStatement#isCross <em>Cross</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getJoinStatement_SingleSource()
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.JoinStatement#getSingleSource <em>Single Source</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getJoinStatement_Expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.JoinStatement#getExpression <em>Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
