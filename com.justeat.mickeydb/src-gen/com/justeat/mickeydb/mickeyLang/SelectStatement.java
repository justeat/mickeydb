...
public interface SelectStatement extends DMLStatement
{
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectStatement_Core()
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectStatement#getCore <em>Core</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectStatement_Orderby()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectStatement#getOrderby <em>Orderby</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectStatement_Limit()
   * @model containment="true"
   * @generated
   */
  Expression getLimit();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectStatement#getLimit <em>Limit</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectStatement_LimitOffset()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectStatement#getLimitOffset <em>Limit Offset</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
