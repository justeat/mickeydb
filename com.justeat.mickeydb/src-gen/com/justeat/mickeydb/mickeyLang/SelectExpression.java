 ...
 *   <li>{@link com.justeat.mickeydb.mickeyLang.SelectExpression#isAllColumns <em>All Columns</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getSelectList <em>Select List</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getSource <em>Source</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getWhere <em>Where</em>}</li>
...
public interface SelectExpression extends SelectCoreExpression
{
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_Distinct()
   * @model
   * @generated
   */
  boolean isDistinct();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#isDistinct <em>Distinct</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setAll(boolean)
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_All()
   * @model
   * @generated
   */
  boolean isAll();
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#isAll <em>All</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_AllColumns()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#isAllColumns <em>All Columns</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_SelectList()
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getSelectList <em>Select List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_Source()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getSource <em>Source</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_Where()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getWhere <em>Where</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_GroupBy()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getGroupBy <em>Group By</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#getSelectExpression_Having()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.justeat.mickeydb.mickeyLang.SelectExpression#getHaving <em>Having</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
