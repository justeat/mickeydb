 ...
 * @generated
 */
public interface MickeyLangFactory extends EFactory
{
  /**
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Mickey Block</em>'.
   * @generated
   */
  MickeyBlock createMickeyBlock();

  /**
   * Returns a new object of class '<em>Mickey Function</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Mickey Function</em>'.
   * @generated
   */
  MickeyFunction createMickeyFunction();
   ...
   * @generated
   */
  MickeyLangPackage getMickeyLangPackage();
