 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.JoinStatementImpl#isNatural <em>Natural</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.JoinStatementImpl#isLeft <em>Left</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.JoinStatementImpl#isOuter <em>Outer</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.JoinStatementImpl#isInner <em>Inner</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.JoinStatementImpl#isCross <em>Cross</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.JoinStatementImpl#getSingleSource <em>Single Source</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.JoinStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinStatementImpl extends MinimalEObjectImpl.Container implements JoinStatement
{
  ...
  {
    return MickeyLangPackage.Literals.JOIN_STATEMENT;
  }
  ...
  public void setNatural(boolean newNatural)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__NATURAL, oldNatural, natural));
  }
  ...
  public void setLeft(boolean newLeft)
  {
    ...
    left = newLeft;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__LEFT, oldLeft, left));
  }
  ...
  public void setOuter(boolean newOuter)
  {
    ...
    outer = newOuter;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__OUTER, oldOuter, outer));
  }
  ...
  public void setInner(boolean newInner)
  {
    ...
    inner = newInner;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__INNER, oldInner, inner));
  }
  ...
  public void setCross(boolean newCross)
  {
    ...
    cross = newCross;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__CROSS, oldCross, cross));
  }
  ...
  public NotificationChain basicSetSingleSource(SingleSource newSingleSource, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__SINGLE_SOURCE, oldSingleSource, newSingleSource);
  ...
  public void setSingleSource(SingleSource newSingleSource)
  {
    if (newSingleSource != singleSource)
    {
      ...
      if (singleSource != null)
        msgs = ((InternalEObject)singleSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.JOIN_STATEMENT__SINGLE_SOURCE, null, msgs);
      if (newSingleSource != null)
        msgs = ((InternalEObject)newSingleSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.JOIN_STATEMENT__SINGLE_SOURCE, null, msgs);
      msgs = basicSetSingleSource(newSingleSource, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__SINGLE_SOURCE, newSingleSource, newSingleSource));
  }
  ...
  public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__EXPRESSION, oldExpression, newExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpression(Expression newExpression)
  {
    if (newExpression != expression)
    {
      NotificationChain msgs = null;
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.JOIN_STATEMENT__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.JOIN_STATEMENT__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.JOIN_STATEMENT__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.JOIN_STATEMENT__SINGLE_SOURCE:
        return basicSetSingleSource(null, msgs);
      case MickeyLangPackage.JOIN_STATEMENT__EXPRESSION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.JOIN_STATEMENT__NATURAL:
        return isNatural();
      case MickeyLangPackage.JOIN_STATEMENT__LEFT:
        return isLeft();
      case MickeyLangPackage.JOIN_STATEMENT__OUTER:
        return isOuter();
      case MickeyLangPackage.JOIN_STATEMENT__INNER:
        return isInner();
      case MickeyLangPackage.JOIN_STATEMENT__CROSS:
        return isCross();
      case MickeyLangPackage.JOIN_STATEMENT__SINGLE_SOURCE:
