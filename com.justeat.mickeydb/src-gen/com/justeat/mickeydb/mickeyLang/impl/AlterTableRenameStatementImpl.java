 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.AlterTableRenameStatementImpl#getTable <em>Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlterTableRenameStatementImpl extends TableDefinitionImpl implements AlterTableRenameStatement
{
  ...
  {
    return MickeyLangPackage.Literals.ALTER_TABLE_RENAME_STATEMENT;
  }
    ...
    if (table != null && table.eIsProxy())
    {
      ...
      if (table != oldTable)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MickeyLangPackage.ALTER_TABLE_RENAME_STATEMENT__TABLE, oldTable, table));
      }
    }
    return table;
  }
  ...
  public void setTable(TableDefinition newTable)
  {
    ...
    table = newTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.ALTER_TABLE_RENAME_STATEMENT__TABLE, oldTable, table));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.ALTER_TABLE_RENAME_STATEMENT__TABLE:
