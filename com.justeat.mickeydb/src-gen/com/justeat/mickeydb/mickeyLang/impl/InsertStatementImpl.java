 ...
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.InsertStatementImpl#getColumnNames <em>Column Names</em>}</li>
...
public class InsertStatementImpl extends DMLStatementImpl implements InsertStatement
{
  ...
  {
    return MickeyLangPackage.Literals.INSERT_STATEMENT;
  }
  ...
  public void setConflictResolution(ConflictResolution newConflictResolution)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INSERT_STATEMENT__CONFLICT_RESOLUTION, oldConflictResolution, conflictResolution));
  }
  ...
  public TableDefinition getTable()
  {
    if (table != null && table.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MickeyLangPackage.INSERT_STATEMENT__TABLE, oldTable, table));
      }
    }
    return table;
  }
  ...
  public void setTable(TableDefinition newTable)
  {
    ...
    table = newTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INSERT_STATEMENT__TABLE, oldTable, table));
  }
  ...
  public EList<ColumnDef> getColumnNames()
  {
    if (columnNames == null)
    {
      columnNames = new EObjectResolvingEList<ColumnDef>(ColumnDef.class, this, MickeyLangPackage.INSERT_STATEMENT__COLUMN_NAMES);
    }
    return columnNames;
  }
  ...
  public EList<Expression> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<Expression>(Expression.class, this, MickeyLangPackage.INSERT_STATEMENT__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain basicSetSelectStatement(SelectStatement newSelectStatement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INSERT_STATEMENT__SELECT_STATEMENT, oldSelectStatement, newSelectStatement);
  ...
  public void setSelectStatement(SelectStatement newSelectStatement)
  {
    if (newSelectStatement != selectStatement)
    {
      ...
      if (selectStatement != null)
        msgs = ((InternalEObject)selectStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.INSERT_STATEMENT__SELECT_STATEMENT, null, msgs);
      if (newSelectStatement != null)
        msgs = ((InternalEObject)newSelectStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.INSERT_STATEMENT__SELECT_STATEMENT, null, msgs);
      msgs = basicSetSelectStatement(newSelectStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INSERT_STATEMENT__SELECT_STATEMENT, newSelectStatement, newSelectStatement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.INSERT_STATEMENT__EXPRESSIONS:
        return ((InternalEList<?>)getExpressions()).basicRemove(otherEnd, msgs);
      case MickeyLangPackage.INSERT_STATEMENT__SELECT_STATEMENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.INSERT_STATEMENT__CONFLICT_RESOLUTION:
        return getConflictResolution();
      case MickeyLangPackage.INSERT_STATEMENT__TABLE:
        if (resolve) return getTable();
        return basicGetTable();
      case MickeyLangPackage.INSERT_STATEMENT__COLUMN_NAMES:
