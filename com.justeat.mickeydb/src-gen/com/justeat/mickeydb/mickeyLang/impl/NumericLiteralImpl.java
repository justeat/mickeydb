 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.NumericLiteralImpl#getNumber <em>Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumericLiteralImpl extends LiteralValueImpl implements NumericLiteral
{
  ...
  {
    return MickeyLangPackage.Literals.NUMERIC_LITERAL;
  }
  ...
  public void setNumber(BigDecimal newNumber)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.NUMERIC_LITERAL__NUMBER, oldNumber, number));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.NUMERIC_LITERAL__NUMBER:
        return getNumber();
    }
