 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.SingleSourceJoinImpl#getJoinSource <em>Join Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingleSourceJoinImpl extends SingleSourceImpl implements SingleSourceJoin
{
  ...
  {
    return MickeyLangPackage.Literals.SINGLE_SOURCE_JOIN;
  }
  ...
  public NotificationChain basicSetJoinSource(JoinSource newJoinSource, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.SINGLE_SOURCE_JOIN__JOIN_SOURCE, oldJoinSource, newJoinSource);
  ...
  public void setJoinSource(JoinSource newJoinSource)
  {
    if (newJoinSource != joinSource)
    {
      ...
      if (joinSource != null)
        msgs = ((InternalEObject)joinSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.SINGLE_SOURCE_JOIN__JOIN_SOURCE, null, msgs);
      if (newJoinSource != null)
        msgs = ((InternalEObject)newJoinSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.SINGLE_SOURCE_JOIN__JOIN_SOURCE, null, msgs);
      msgs = basicSetJoinSource(newJoinSource, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.SINGLE_SOURCE_JOIN__JOIN_SOURCE, newJoinSource, newJoinSource));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.SINGLE_SOURCE_JOIN__JOIN_SOURCE:
