 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTableStatementImpl#isTemporary <em>Temporary</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTableStatementImpl#getColumnDefs <em>Column Defs</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTableStatementImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreateTableStatementImpl extends TableDefinitionImpl implements CreateTableStatement
{
  ...
  {
    return MickeyLangPackage.Literals.CREATE_TABLE_STATEMENT;
  }
  ...
  public void setTemporary(boolean newTemporary)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TABLE_STATEMENT__TEMPORARY, oldTemporary, temporary));
  }
  ...
  public EList<ColumnSource> getColumnDefs()
  {
    if (columnDefs == null)
    {
      columnDefs = new EObjectContainmentEList<ColumnSource>(ColumnSource.class, this, MickeyLangPackage.CREATE_TABLE_STATEMENT__COLUMN_DEFS);
    }
    return columnDefs;
  }
  ...
  public EList<TableConstraint> getConstraints()
  {
    if (constraints == null)
    {
      constraints = new EObjectContainmentEList<TableConstraint>(TableConstraint.class, this, MickeyLangPackage.CREATE_TABLE_STATEMENT__CONSTRAINTS);
    }
    return constraints;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.CREATE_TABLE_STATEMENT__COLUMN_DEFS:
        return ((InternalEList<?>)getColumnDefs()).basicRemove(otherEnd, msgs);
      case MickeyLangPackage.CREATE_TABLE_STATEMENT__CONSTRAINTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.CREATE_TABLE_STATEMENT__TEMPORARY:
        return isTemporary();
      case MickeyLangPackage.CREATE_TABLE_STATEMENT__COLUMN_DEFS:
