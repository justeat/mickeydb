 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.NotNullConstraintImpl#getConflictClause <em>Conflict Clause</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotNullConstraintImpl extends ColumnConstraintImpl implements NotNullConstraint
{
  ...
  {
    return MickeyLangPackage.Literals.NOT_NULL_CONSTRAINT;
  }
  ...
  public NotificationChain basicSetConflictClause(ConflictClause newConflictClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.NOT_NULL_CONSTRAINT__CONFLICT_CLAUSE, oldConflictClause, newConflictClause);
  ...
  public void setConflictClause(ConflictClause newConflictClause)
  {
    if (newConflictClause != conflictClause)
    {
      ...
      if (conflictClause != null)
        msgs = ((InternalEObject)conflictClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.NOT_NULL_CONSTRAINT__CONFLICT_CLAUSE, null, msgs);
      if (newConflictClause != null)
        msgs = ((InternalEObject)newConflictClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.NOT_NULL_CONSTRAINT__CONFLICT_CLAUSE, null, msgs);
      msgs = basicSetConflictClause(newConflictClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.NOT_NULL_CONSTRAINT__CONFLICT_CLAUSE, newConflictClause, newConflictClause));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.NOT_NULL_CONSTRAINT__CONFLICT_CLAUSE:
