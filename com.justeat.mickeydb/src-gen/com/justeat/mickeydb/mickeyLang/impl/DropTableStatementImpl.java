...
public class DropTableStatementImpl extends DDLStatementImpl implements DropTableStatement
{
  ...
  {
    return MickeyLangPackage.Literals.DROP_TABLE_STATEMENT;
  }
  ...
  public void setIfExists(boolean newIfExists)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.DROP_TABLE_STATEMENT__IF_EXISTS, oldIfExists, ifExists));
  }
  ...
  public TableDefinition getTable()
  {
    if (table != null && table.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MickeyLangPackage.DROP_TABLE_STATEMENT__TABLE, oldTable, table));
      }
    }
    return table;
  }
  ...
  public void setTable(TableDefinition newTable)
  {
    ...
    table = newTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.DROP_TABLE_STATEMENT__TABLE, oldTable, table));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.DROP_TABLE_STATEMENT__IF_EXISTS:
        return isIfExists();
      case MickeyLangPackage.DROP_TABLE_STATEMENT__TABLE:
