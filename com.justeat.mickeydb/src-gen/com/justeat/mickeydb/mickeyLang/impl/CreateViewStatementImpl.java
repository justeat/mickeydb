 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateViewStatementImpl#isTemporary <em>Temporary</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateViewStatementImpl#getSelectStatement <em>Select Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreateViewStatementImpl extends TableDefinitionImpl implements CreateViewStatement
{
  ...
  {
    return MickeyLangPackage.Literals.CREATE_VIEW_STATEMENT;
  }
  ...
  public void setTemporary(boolean newTemporary)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_VIEW_STATEMENT__TEMPORARY, oldTemporary, temporary));
  }
  ...
  public NotificationChain basicSetSelectStatement(SelectStatement newSelectStatement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_VIEW_STATEMENT__SELECT_STATEMENT, oldSelectStatement, newSelectStatement);
  ...
  public void setSelectStatement(SelectStatement newSelectStatement)
  {
    if (newSelectStatement != selectStatement)
    {
      ...
      if (selectStatement != null)
        msgs = ((InternalEObject)selectStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.CREATE_VIEW_STATEMENT__SELECT_STATEMENT, null, msgs);
      if (newSelectStatement != null)
        msgs = ((InternalEObject)newSelectStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.CREATE_VIEW_STATEMENT__SELECT_STATEMENT, null, msgs);
      msgs = basicSetSelectStatement(newSelectStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_VIEW_STATEMENT__SELECT_STATEMENT, newSelectStatement, newSelectStatement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.CREATE_VIEW_STATEMENT__SELECT_STATEMENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.CREATE_VIEW_STATEMENT__TEMPORARY:
        return isTemporary();
      case MickeyLangPackage.CREATE_VIEW_STATEMENT__SELECT_STATEMENT:
