 ...
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTriggerStatementImpl#getWhen <em>When</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTriggerStatementImpl#getEventType <em>Event Type</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTriggerStatementImpl#getUpdateColumnNames <em>Update Column Names</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTriggerStatementImpl#getTable <em>Table</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.CreateTriggerStatementImpl#getForEachRow <em>For Each Row</em>}</li>
...
public class CreateTriggerStatementImpl extends DDLStatementImpl implements CreateTriggerStatement
{
  ...
  {
    return MickeyLangPackage.Literals.CREATE_TRIGGER_STATEMENT;
  }
  ...
  public void setTemporary(boolean newTemporary)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__TEMPORARY, oldTemporary, temporary));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__NAME, oldName, name));
  }
  ...
  public void setWhen(String newWhen)
  {
    ...
    when = newWhen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__WHEN, oldWhen, when));
  }
  ...
  public void setEventType(String newEventType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__EVENT_TYPE, oldEventType, eventType));
  }
  ...
  public EList<String> getUpdateColumnNames()
  {
    ...
    {
      updateColumnNames = new EDataTypeEList<String>(String.class, this, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__UPDATE_COLUMN_NAMES);
    }
  ...
  public TableDefinition getTable()
  {
    if (table != null && table.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__TABLE, oldTable, table));
      }
    }
    return table;
  }
  ...
  public void setTable(TableDefinition newTable)
  {
    ...
    table = newTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__TABLE, oldTable, table));
  }
  ...
  public void setForEachRow(String newForEachRow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__FOR_EACH_ROW, oldForEachRow, forEachRow));
  }
  ...
  public NotificationChain basicSetWhenExpression(Expression newWhenExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__WHEN_EXPRESSION, oldWhenExpression, newWhenExpression);
  ...
  public void setWhenExpression(Expression newWhenExpression)
  {
    if (newWhenExpression != whenExpression)
    {
      ...
      if (whenExpression != null)
        msgs = ((InternalEObject)whenExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.CREATE_TRIGGER_STATEMENT__WHEN_EXPRESSION, null, msgs);
      if (newWhenExpression != null)
        msgs = ((InternalEObject)newWhenExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.CREATE_TRIGGER_STATEMENT__WHEN_EXPRESSION, null, msgs);
      msgs = basicSetWhenExpression(newWhenExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__WHEN_EXPRESSION, newWhenExpression, newWhenExpression));
  }
  ...
  public EList<DMLStatement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<DMLStatement>(DMLStatement.class, this, MickeyLangPackage.CREATE_TRIGGER_STATEMENT__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__WHEN_EXPRESSION:
        return basicSetWhenExpression(null, msgs);
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__STATEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__TEMPORARY:
        return isTemporary();
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__NAME:
        return getName();
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__WHEN:
        return getWhen();
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__EVENT_TYPE:
        return getEventType();
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__UPDATE_COLUMN_NAMES:
        return getUpdateColumnNames();
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__TABLE:
        if (resolve) return getTable();
        return basicGetTable();
      case MickeyLangPackage.CREATE_TRIGGER_STATEMENT__FOR_EACH_ROW:
