 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.ColumnDefImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.ColumnDefImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnDefImpl extends ColumnSourceImpl implements ColumnDef
{
  ...
  {
    return MickeyLangPackage.Literals.COLUMN_DEF;
  }
  ...
  public void setType(ColumnType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.COLUMN_DEF__TYPE, oldType, type));
  }
  ...
  public EList<ColumnConstraint> getConstraints()
  {
    if (constraints == null)
    {
      constraints = new EObjectContainmentEList<ColumnConstraint>(ColumnConstraint.class, this, MickeyLangPackage.COLUMN_DEF__CONSTRAINTS);
    }
    return constraints;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.COLUMN_DEF__CONSTRAINTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.COLUMN_DEF__TYPE:
        return getType();
      case MickeyLangPackage.COLUMN_DEF__CONSTRAINTS:
