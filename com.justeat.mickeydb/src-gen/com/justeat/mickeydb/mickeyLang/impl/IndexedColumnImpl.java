 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.IndexedColumnImpl#getColumnReference <em>Column Reference</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.IndexedColumnImpl#getCollationName <em>Collation Name</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.IndexedColumnImpl#isAsc <em>Asc</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.IndexedColumnImpl#isDesc <em>Desc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexedColumnImpl extends MinimalEObjectImpl.Container implements IndexedColumn
{
  ...
  {
    return MickeyLangPackage.Literals.INDEXED_COLUMN;
  }
    ...
    if (columnReference != null && columnReference.eIsProxy())
    {
      ...
      if (columnReference != oldColumnReference)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MickeyLangPackage.INDEXED_COLUMN__COLUMN_REFERENCE, oldColumnReference, columnReference));
      }
    }
  ...
  public void setColumnReference(ColumnDef newColumnReference)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INDEXED_COLUMN__COLUMN_REFERENCE, oldColumnReference, columnReference));
  }
  ...
  public void setCollationName(String newCollationName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INDEXED_COLUMN__COLLATION_NAME, oldCollationName, collationName));
  }
  ...
  public void setAsc(boolean newAsc)
  {
    ...
    asc = newAsc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INDEXED_COLUMN__ASC, oldAsc, asc));
  }
  ...
  public void setDesc(boolean newDesc)
  {
    ...
    desc = newDesc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.INDEXED_COLUMN__DESC, oldDesc, desc));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.INDEXED_COLUMN__COLUMN_REFERENCE:
        if (resolve) return getColumnReference();
        return basicGetColumnReference();
      case MickeyLangPackage.INDEXED_COLUMN__COLLATION_NAME:
        return getCollationName();
      case MickeyLangPackage.INDEXED_COLUMN__ASC:
        return isAsc();
      case MickeyLangPackage.INDEXED_COLUMN__DESC:
        return isDesc();
    }
