...
public class PrimaryKeyColumnConstraintImpl extends ColumnConstraintImpl implements PrimaryKeyColumnConstraint
{
  ...
  {
    return MickeyLangPackage.Literals.PRIMARY_KEY_COLUMN_CONSTRAINT;
  }
  ...
  public void setAsc(boolean newAsc)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.PRIMARY_KEY_COLUMN_CONSTRAINT__ASC, oldAsc, asc));
  }
  ...
  public void setDesc(boolean newDesc)
  {
    ...
    desc = newDesc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.PRIMARY_KEY_COLUMN_CONSTRAINT__DESC, oldDesc, desc));
  }
  ...
  public void setAutoincrement(boolean newAutoincrement)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.PRIMARY_KEY_COLUMN_CONSTRAINT__AUTOINCREMENT, oldAutoincrement, autoincrement));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.PRIMARY_KEY_COLUMN_CONSTRAINT__ASC:
        return isAsc();
      case MickeyLangPackage.PRIMARY_KEY_COLUMN_CONSTRAINT__DESC:
        return isDesc();
      case MickeyLangPackage.PRIMARY_KEY_COLUMN_CONSTRAINT__AUTOINCREMENT:
