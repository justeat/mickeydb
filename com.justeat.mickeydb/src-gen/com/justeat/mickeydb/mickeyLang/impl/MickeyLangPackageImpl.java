...
import com.justeat.mickeydb.mickeyLang.ColumnConstraint;
...
import com.justeat.mickeydb.mickeyLang.DefaultValue;
 ...
 * @generated
 */
public class MickeyLangPackageImpl extends EPackageImpl implements MickeyLangPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass mickeyBlockEClass = null;
   ...
   * @generated
   */
  private EClass mickeyFunctionEClass = null;
   ...
   * @see com.justeat.mickeydb.mickeyLang.MickeyLangPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MickeyLangPackageImpl()
  {
    super(eNS_URI, MickeyLangFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link MickeyLangPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MickeyLangPackage init()
  {
    if (isInited) return (MickeyLangPackage)EPackage.Registry.INSTANCE.getEPackage(MickeyLangPackage.eNS_URI);

    // Obtain or create and register package
    MickeyLangPackageImpl theMickeyLangPackage = (MickeyLangPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MickeyLangPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MickeyLangPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theMickeyLangPackage.createPackageContents();

    // Initialize created meta-data
    theMickeyLangPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMickeyLangPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MickeyLangPackage.eNS_URI, theMickeyLangPackage);
    return theMickeyLangPackage;
  }
   ...
   * @generated
   */
  public EClass getMickeyBlock()
  {
    return mickeyBlockEClass;
  }
   ...
   * @generated
   */
  public EClass getMickeyFunction()
  {
    return mickeyFunctionEClass;
  }
   ...
   * @generated
   */
  public EAttribute getMickeyFunction_Name()
  {
    return (EAttribute)mickeyFunctionEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getMickeyFunction_Args()
  {
    return (EReference)mickeyFunctionEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EReference)contentUriEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getContentUri_Type()
  {
   ...
   * @generated
   */
  public EAttribute getContentUri_Unique()
  {
    return (EAttribute)contentUriEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public MickeyLangFactory getMickeyLangFactory()
  {
    return (MickeyLangFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(contentUriEClass, CONTENT_URI__TYPE);
    createEAttribute(contentUriEClass, CONTENT_URI__UNIQUE);
  ...
  public void initializePackageContents()
  {
    ...
    mickeyFunctionEClass.getESuperTypes().add(this.getMickeyBlock());
    actionStatementEClass.getESuperTypes().add(this.getMickeyBlock());
    migrationBlockEClass.getESuperTypes().add(this.getMickeyBlock());
    ...
    ddlStatementEClass.getESuperTypes().add(this.getMickeyBlock());
    ...
    initEReference(getContentUri_Type(), this.getTableDefinition(), null, "type", null, 0, 1, ContentUri.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getContentUri_Unique(), ecorePackage.getEBoolean(), "unique", null, 0, 1, ContentUri.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
