 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.OldColumnImpl#getColumn <em>Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OldColumnImpl extends ExpressionImpl implements OldColumn
{
  ...
  {
    return MickeyLangPackage.Literals.OLD_COLUMN;
  }
    ...
    if (column != null && column.eIsProxy())
    {
      ...
      if (column != oldColumn)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MickeyLangPackage.OLD_COLUMN__COLUMN, oldColumn, column));
      }
    }
    return column;
  }
  ...
  public void setColumn(ColumnSource newColumn)
  {
    ...
    column = newColumn;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.OLD_COLUMN__COLUMN, oldColumn, column));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.OLD_COLUMN__COLUMN:
