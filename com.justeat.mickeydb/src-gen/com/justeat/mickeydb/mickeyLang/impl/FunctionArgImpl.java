 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.FunctionArgImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.FunctionArgImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionArgImpl extends MinimalEObjectImpl.Container implements FunctionArg
{
  ...
  {
    return MickeyLangPackage.Literals.FUNCTION_ARG;
  }
  ...
  public void setType(ColumnType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.FUNCTION_ARG__TYPE, oldType, type));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.FUNCTION_ARG__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.FUNCTION_ARG__TYPE:
        return getType();
      case MickeyLangPackage.FUNCTION_ARG__NAME:
        return getName();
    }
