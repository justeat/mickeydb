...
public class PrimaryConstraintImpl extends TableConstraintImpl implements PrimaryConstraint
{
  ...
  {
    return MickeyLangPackage.Literals.PRIMARY_CONSTRAINT;
  }
  ...
  public EList<IndexedColumn> getColumns()
  {
    if (columns == null)
    {
      columns = new EObjectContainmentEList<IndexedColumn>(IndexedColumn.class, this, MickeyLangPackage.PRIMARY_CONSTRAINT__COLUMNS);
    }
    return columns;
  }
  ...
  public NotificationChain basicSetConflictClause(ConflictClause newConflictClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.PRIMARY_CONSTRAINT__CONFLICT_CLAUSE, oldConflictClause, newConflictClause);
  ...
  public void setConflictClause(ConflictClause newConflictClause)
  {
    if (newConflictClause != conflictClause)
    {
      ...
      if (conflictClause != null)
        msgs = ((InternalEObject)conflictClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.PRIMARY_CONSTRAINT__CONFLICT_CLAUSE, null, msgs);
      if (newConflictClause != null)
        msgs = ((InternalEObject)newConflictClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.PRIMARY_CONSTRAINT__CONFLICT_CLAUSE, null, msgs);
      msgs = basicSetConflictClause(newConflictClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.PRIMARY_CONSTRAINT__CONFLICT_CLAUSE, newConflictClause, newConflictClause));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.PRIMARY_CONSTRAINT__COLUMNS:
        return ((InternalEList<?>)getColumns()).basicRemove(otherEnd, msgs);
      case MickeyLangPackage.PRIMARY_CONSTRAINT__CONFLICT_CLAUSE:
