 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.SingleSourceSelectStatementImpl#getSelectStatement <em>Select Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingleSourceSelectStatementImpl extends SelectSourceImpl implements SingleSourceSelectStatement
{
  ...
  {
    return MickeyLangPackage.Literals.SINGLE_SOURCE_SELECT_STATEMENT;
  }
  ...
  public NotificationChain basicSetSelectStatement(SelectStatement newSelectStatement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MickeyLangPackage.SINGLE_SOURCE_SELECT_STATEMENT__SELECT_STATEMENT, oldSelectStatement, newSelectStatement);
  ...
  public void setSelectStatement(SelectStatement newSelectStatement)
  {
    if (newSelectStatement != selectStatement)
    {
      ...
      if (selectStatement != null)
        msgs = ((InternalEObject)selectStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.SINGLE_SOURCE_SELECT_STATEMENT__SELECT_STATEMENT, null, msgs);
      if (newSelectStatement != null)
        msgs = ((InternalEObject)newSelectStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MickeyLangPackage.SINGLE_SOURCE_SELECT_STATEMENT__SELECT_STATEMENT, null, msgs);
      msgs = basicSetSelectStatement(newSelectStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.SINGLE_SOURCE_SELECT_STATEMENT__SELECT_STATEMENT, newSelectStatement, newSelectStatement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MickeyLangPackage.SINGLE_SOURCE_SELECT_STATEMENT__SELECT_STATEMENT:
