 ...
 * </p>
 * <ul>
 *   <li>{@link com.justeat.mickeydb.mickeyLang.impl.ConflictClauseImpl#getResolution <em>Resolution</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConflictClauseImpl extends MinimalEObjectImpl.Container implements ConflictClause
{
  ...
  {
    return MickeyLangPackage.Literals.CONFLICT_CLAUSE;
  }
  ...
  public void setResolution(ConflictResolution newResolution)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MickeyLangPackage.CONFLICT_CLAUSE__RESOLUTION, oldResolution, resolution));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MickeyLangPackage.CONFLICT_CLAUSE__RESOLUTION:
