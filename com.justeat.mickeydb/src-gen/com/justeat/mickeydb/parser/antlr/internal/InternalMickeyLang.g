...
entryRuleMickeyBlock returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMickeyBlockRule()); }
	 iv_ruleMickeyBlock=ruleMickeyBlock 
	 { $current=$iv_ruleMickeyBlock.current; } 
	 EOF 
;

// Rule MickeyBlock
ruleMickeyBlock returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_MickeyFunction_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DDLStatement_2.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_MigrationBlock_3.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleMickeyFunction returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMickeyFunctionRule()); }
	 iv_ruleMickeyFunction=ruleMickeyFunction 
	 { $current=$iv_ruleMickeyFunction.current; } 
	 EOF 
;

// Rule MickeyFunction
ruleMickeyFunction returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='function' 
